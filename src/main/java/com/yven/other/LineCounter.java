...
//        String path = System.getProperty("user.dir");
    ...
    public static void main(String args[]) {
        ...
        //lc.counter("C:\\yven\\spring\\spring-framework"); //$NON-NLS-1$
        lc.counter("C:\\yven\\tomcat7\\apache-tomcat-7.0.88-src"); //$NON-NLS-1$
    }
}
////img.alicdn.com/tfscom/TB1gtZ1ukOWBuNjSsppwu0PgpXa.png
